...
let dateBuilder = (weekDay, date, m, year) => {
  ...
  switch (weekDay) {
    case 'MON':
      day = screenWidth < 500 ? "Mon" : "Monday";
      break;
    case 'TUE':
      day = screenWidth < 500 ? "Tue" : "Tuesday";
      break;
    case 'WED':
      day = screenWidth < 500 ? "Wed" : "Wednesday";
      break;
    case 'THU':
      day = screenWidth < 500 ? "Thu" : "Thursday";
      break;
    case 'FRI':
      day = screenWidth < 500 ? "Fri" : "Friday";
      break;
    case 'SAT':
      day = screenWidth < 500 ? "Sat" : "Saturday";
      break;
    case 'SUN':
      day = screenWidth < 500 ? "Sun" : "Sunday";
      break;
  };
